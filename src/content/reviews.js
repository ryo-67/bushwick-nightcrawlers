export const reviews = {
  ...
  'tabitha-von-wyckoff': {
    ...
    rating: 5,
    date: 'April 2026',
    text: `Mood Ring is the most authentic dive in Bushwick, and I say this with my whole chest. My architecture friends from Cornell put me onto it (which is its own kind of validation). Smoke machine, Wong Kar-wai snippets through the wall, drainpipe rats which add character. I've been bringing my Architecture Digest book club for three months. The bartender (Vanessa, I think?) remembers my order, which to me signals real community. She also visibly sighs when I walk in. I've decided that's part of the charm. The other rats here have such an interesting authenticity. Took my Asian Studies elective at Cornell so I get the references. I've decided I'm staying in Bushwick. Five stars. Yelp Elite '24, '25, working on '26.`,
  },
  'vintage-vermin': {
